...
INTENT_MODEL_PT_PATH = Path("../output-models/model_get_user_info.pt")
...
# curl -X POST "http://vscode:8001/predict"      -H "Content-Type: application/json"      -d '{"text": "quiero reservar una habitación"}'
...
if __name__ == "__main__":
    uvicorn.run(
        "get_user_info-web-app-only-intent:app",
        host=SERVER_HOST,
        port=SERVER_PORT,
